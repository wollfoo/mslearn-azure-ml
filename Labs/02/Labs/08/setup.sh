...
REGIONS=("eastus" "westus" "southcentralus" "westus2" "westeurope" "eastus2" "australiaeast" "southeastasia")
...
az ml compute create --name ${COMPUTE_INSTANCE} --size STANDARD_F2S_V2 --type ComputeInstance 
